...
Drivers/GB/%.o Drivers/GB/%.su: ../Drivers/GB/%.c Drivers/GB/subdir.mk
...
clean: clean-Drivers-2f-GB

clean-Drivers-2f-GB:
	-$(RM) ./Drivers/GB/GB.d ./Drivers/GB/GB.o ./Drivers/GB/GB.su

.PHONY: clean-Drivers-2f-GB
